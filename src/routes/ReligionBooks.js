...
function ReligionBooks(){
    ...
    function getAllWorks(page){
        ...
        return fetch("https://openlibrary.org/search.json?q=ddc:2*%20language:eng&sort=new&limit=" + limit + "&offset=" + offset + "&fields=seed")
    ...
    function handlePageClick(event){
        setIsLoading(true);
        navigate({pathname: "/religion", search: "?page=" + (event.selected + 1)});
    }
